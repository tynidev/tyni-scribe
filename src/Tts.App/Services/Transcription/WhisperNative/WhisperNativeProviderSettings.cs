...
public static class WhisperNativeProviderSettings
{
    ...
    public static WhisperNativeProviderTranscriptionSettings Parse(IReadOnlyDictionary<string, string> settings)
    {
        var normalized = Normalize(settings);

        return new WhisperNativeProviderTranscriptionSettings(
...
public sealed record WhisperNativeProviderTranscriptionSettings(
    string ModelId,
